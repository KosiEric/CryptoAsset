            ...
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2">
                    <div class="haeder-text">
                        <h1><?php echo $website_details->SiteName;?> - Our Terms and Conditions</h1>
        ...
        <div class="row about-text justify-content">
            <div class="col-md-6">
                <div class="about-info" id="learn-more">
                    ...
                    <h2>Welcome to mTranzact</h2>
                    <p>These terms and conditions outline the rules and regulations for the use of mTranzact's Website.</p> <br />
                    <span style="text-transform: capitalize;"> mTranzact</span> is located at:<br />
                    <address> , <br /> - , <br />
                    </address>
                    <p>By accessing this website we assume you accept these terms and conditions in full. Do not continue to use mTranzact's website
                    ...
                    <p>We employ the use of cookies. By using mTranzact's website you consent to the use of cookies
                        in accordance with mTranzact’s privacy policy.</p><p>Most of the modern day interactive web sites
                        use cookies to enable us to retrieve user details for each visit. Cookies are used in some areas of our site
                        to enable the functionality of this area and ease of use for those people visiting. Some of our
                        affiliate / advertising partners may also use cookies.</p><h2>License</h2>
                    <p>Unless otherwise stated, mTranzact and/or it’s licensors own the intellectual property rights for
                        all material on mTranzact. All intellectual property rights are reserved. You may view and/or print
                        pages from http://www.mtranzact.com for your own personal use subject to restrictions set in these terms and conditions.</p>
                    <p>You must not:</p>
                    <ol>
                        <li>Republish material from http://www.mtranzact.com</li>
                        <li>Sell, rent or sub-license material from http://www.mtranzact.com</li>
                        <li>Reproduce, duplicate or copy material from http://www.mtranzact.com</li>
                    </ol>
                    <p>Redistribute content from mTranzact (unless content is specifically made for redistribution).</p>
                    <h2>User Comments</h2>
                    <ol>
                        <li>This Agreement shall begin on the date hereof.</li>
                        <li>Certain parts of this website offer the opportunity for users to post and exchange opinions, information,
                            material and data ('Comments') in areas of the website. mTranzact does not screen, edit, publish
                            or review Comments prior to their appearance on the website and Comments do not reflect the views or
                            opinions ofmTranzact, its agents or affiliates. Comments reflect the view and opinion of the
                            person who posts such view or opinion. To the extent permitted by applicable laws mTranzactshall
                            ...
                            website.</li>
                        <li>mTranzactreserves the right to monitor all Comments and to remove any Comments which it considers
                        ...
                        <li>You hereby grant to <strong>mTranzact</strong> a non-exclusive royalty-free license to use, reproduce,
                    ...
                    <p>If you are among the organizations listed in paragraph 2 above and are interested in linking to our website,
                        you must notify us by sending an e-mail to <a href="mailto:contact@mtranzact.com" title="send an email to contact@mtranzact.com">contact@mtranzact.com</a>.
                    ...
                    <p>No use of mTranzact’s logo or other artwork will be allowed for linking absent a trademark license
                        agreement.</p>
                    <h2>Iframes</h2>
