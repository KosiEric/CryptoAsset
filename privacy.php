            ...
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2">
                    <div class="haeder-text">
                        <h1><?php echo $website_details->SiteName;?> - Our Privacy Policy</h1>
        ...
        <div class="row about-text justify-content">
            <div class="col-md-6">
                <div class="about-info" id="learn-more">
                    <h1>Privacy Policy of mTranzact</h1>

                    <p>mTranzact operates the mTranzact.com website, which provides the SERVICE.</p>

                    <p>This page is used to inform website visitors regarding our policies with the collection, use, and disclosure of Personal Information if anyone decided to use our Service, the mTranzact website.</p>

                    <p>If you choose to use our Service, then you agree to the collection and use of information in relation with this policy. The Personal Information that we collect are used for providing and improving the Service. We will not use or share your information with anyone except as described in this Privacy Policy.</p>

                    <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at mTranzact.com, unless otherwise defined in this Privacy Policy.</p>
