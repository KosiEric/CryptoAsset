...
<!-- Mirrored from phpcryptomarket.bdtask.com/demo-v1.6/home by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Oct 2018 01:51:42 GMT -->
...
<head>
        ...
        <title>Home - Crypto Currency Treading System</title>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="slide-text text-center">
                                        <h2>The Feature of <span class="outrageous-orange">Financing</span> <br>Technology is Here</h2>
                                        ...
                                        <div class="slide-buttons">
                                            <a href="https://www.bdtask.com/" class="slide-btn">Get in touch</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="slide-text">
                                        <h2>Bitcoin <span class="bright-turquoise">Exchange</span><br>You Can Trust</h2>
                                        ...
                                        <div class="slide-buttons">
                                            <a href="https://www.bdtask.com/" class="slide-btn">Click Here</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="slide-text text-right">
                                        <h2>Take the world's  best <br><span class="navy-blue">Cryptocurrency</span>  Site.</h2>
                                        <p>Miker Ipsum is simply dummy text of the printing and typesetting industry.<br> Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</p>
                                        <div class="slide-buttons">
                                            <a href="https://www.bdtask.com/" class="slide-btn">Start Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row about-text justify-content">
                    <div class="col-md-6">
                        <div class="about-info">
                            ...
                            <div class="definition">ICO Crypto is a platform for the future of funding that powering dat for the new equity blockchain</div>
...
<p>All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator.</p>                            <a href="contact.php" class="btn btn-default mr-20 mb-10">Contact Us</a>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="quote">
                            It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout.                            <div class="author-address">Tarek Sumch - Owner, Bdtask</div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-sm-8 col-sm-offset-2">
                        <div class="section_title">
                            <h3>Quick Bitcoin <span>Converter</span></h3>
                                <p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum.</p>                        </div>
                    </div>
                </div>
                <div class="row justify-content">
                    <div class="col-sm-4">
                        <div class="bitcoin-sack">
                            <img src="upload/1bdb688b0774ccb380813b393b52119e.png" class="img-responsive center-block" alt="Quick Bitcoin Converter">
                        </div>
                    </div>
                    <div class="col-sm-8">
...
<p>It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English.</p>                            </div>
            ...
            <div class="container">
                ...
                <div class="col-sm-3">
                    <div class="feature__box">
                        ...
                        <div class="feature__content">
                            <h3><a href="service/data-protection.html">Data Protection</a></h3>
                ...
                <div class="col-sm-3">
                    <div class="feature__box">
                        ...
                        <div class="feature__content">
                            <h3><a href="service/security-protected.html">Security Protected</a></h3>
                                <p>Perfectly elaborated and calculated investment plans for depositPerfectly elaborated and c profit during the entire term of the deposit.</p>
                        </div>
                    </div>
                </div>
        ...
        <div class="crypto-strat">
            <div class="container">
                ...
                <div class="start-steps">
                    <div class="start-step">
                        ...
                        <div class="start-step-info">
                            ...
                            <div class="step-text">
                                <span>All the Lorem Ipsum generators on the Internet tend to rdefined chunks as making this the</span>
                            </div>
                        </div>
                    </div>
                    <div class="start-step">
                ...
                <a href="buy.html" class="btn btn-default">Get Start</a>
            </div>
        </div>
            ...
            <div class="with-nav-tabs currency-tabs">
                <div class="tab-header">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#crypto" data-toggle="tab">Crypto Coins</a></li>
                    </ul>
                </div>
                <div class="container">
                        ...
                        <div class="tab-pane fade in active" id="crypto">
                            ...
                            <table class="table table-striped table-hover nowrap" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                        ...
                                        <td>$ <span class="price value_cap" id="PRICE_BTC"></span></td>
                                        ...
                                        <td>$ <span class="price value_cap" id="PRICE_ETH"></span></td>
                                        ...
                                        <td>$ <span class="price value_cap" id="PRICE_LTC"></span></td>
                                        ...
                                        <td>$ <span class="price value_cap" id="PRICE_DASH"></span></td>
                                        ...
                                        <td>$ <span class="price value_cap" id="PRICE_XMR"></span></td>
                                        ...
                                        <td>$ <span class="price value_cap" id="PRICE_NXT"></span></td>
                                        ...
                                        <td>$ <span class="price value_cap" id="PRICE_ETC"></span></td>
                                        ...
                                        <td>$ <span class="price value_cap" id="PRICE_DOGE"></span></td>
                                        ...
                                        <td>$ <span class="price value_cap" id="PRICE_ZEC"></span></td>
                                        ...
                                        <td>$ <span class="price value_cap" id="PRICE_BTS"></span></td>
                ...
                <div class="row">
                        ...
                        <div class="owl-testimonial owl-carousel owl-theme">
                            <div class="testimonial-panel">
                                <div class="tes-quoteInfo">
                                    <img src="upload/testimonial/6ffe1bf3d45733f495e37e1c625844c2.jpg" class="quoteAvatar" alt="John Deo">
                                    <div>
                                        <div class="quoteAuthor"><span>John Deo</span></div>
                                        <div class="quotePosition">
                                            <span>Co-founder of Microsoft, American business management</span>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-sm-12">
                        <div class="client-logo">
                            ...
                            <div class="logo-item">
                                <a href="https://www.bdtask.com/" target="_blank"><img src="upload/client/01.png" class="img-responsive" alt="Bdtask"></a>
                            </div>
                            <div class="logo-item">
                                <a href="https://www.bdtask.com/" target="_blank"><img src="upload/client/02.png" class="img-responsive" alt="Bdtask"></a>
                            </div>
                            <div class="logo-item">
                                <a href="https://www.bdtask.com/" target="_blank"><img src="upload/client/03.png" class="img-responsive" alt="Bdtask"></a>
                            </div>
                            <div class="logo-item">
                                <a href="https://www.bdtask.com/" target="_blank"><img src="upload/client/04.png" class="img-responsive" alt="Bdtask"></a>
                            </div>
                            <div class="logo-item">
                                <a href="https://www.bdtask.com/" target="_blank"><img src="upload/client/05.png" class="img-responsive" alt="Bdtask"></a>
                            </div>
                            <div class="logo-item">
                                <a href="https://www.bdtask.com/" target="_blank"><img src="upload/client/06.png" class="img-responsive" alt="Bdtask"></a>
                            </div>
                            <div class="logo-item">
                                <a href="https://www.bdtask.com/" target="_blank"><img src="upload/client/07.png" class="img-responsive" alt="Bdtask"></a>
                            </div>
                            <div class="logo-item">
                                <a href="https://www.bdtask.com/" target="_blank"><img src="upload/client/08.png" class="img-responsive" alt="Bdtask"></a>
                            </div>
                            <!-- /.End of client logo -->
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="owl-blog owl-carousel owl-theme">
                        ...
                        <div class="item">
                            <div class="post_grid">
                                <div class="grid_img">
                                    <img src="upload/news/e8c9b79ff91acd804c8a8611affe6ade.jpg" class="img-responsive" alt="Bitcoin Cash Price Trend Including Tether">
                                </div>
                                <div class="grid_body">
                                    <h3 class="post_heading"><a href="news/trading/bitcoin-cash-price-trend-including-tether.html">Bitcoin Cash Price Trend Including Tether</a></h3>
                                    <time datetime="2018-04-09 10:43:42" class="time">
                                        9th, April 2018    
                                    </time>
                        ...
                        <div class="item">
                            <div class="post_grid">
                                <div class="grid_img">
                                    <img src="upload/news/ef423f8d1be6f3f6a00c7c59cabbfcaa.jpg" class="img-responsive" alt="Bitfinex Introduces Trading for 12 Altcoins">
                                </div>
                                <div class="grid_body">
                                    <h3 class="post_heading"><a href="news/trading/bitfinex-introduces-trading-for-12-altcoins.html">Bitfinex Introduces Trading for 12 Altcoins</a></h3>
                                    <time datetime="2018-04-09 10:34:42" class="time">
                                        9th, April 2018    
                                    </time>
                                    <p>Lorem ipsum dolor sit amet, quo omittam moderatius in, te cum mutat malorum. Autem ullum cu sed. Id per enim d</p>
                                </div>
                        ...
                        <div class="item">
                            <div class="post_grid">
                                <div class="grid_img">
                                    <img src="upload/news/6ed8f39e635fdf5efe114fb891d53ccc.jpg" class="img-responsive" alt="Ripple Price Technical Analysis – XRP/USD">
                                </div>
                                <div class="grid_body">
                                    <h3 class="post_heading"><a href="news/trading/ripple-price-technical-analysis-xrpusd.html">Ripple Price Technical Analysis – XRP/USD</a></h3>
                                    <time datetime="2018-04-09 10:44:42" class="time">
                                        9th, April 2018    
                                    </time>
                                    <p>Lorem ipsum dolor sit amet, quo omittam moderatius in, te cum mutat malorum. Autem ullum cu sed. Id per enim d</p>
                                </div>
                        ...
                        <div class="item">
                            <div class="post_grid">
                                <div class="grid_img">
                                    <img src="upload/news/3646c01da54507fd2b0ad3b2ec1a168d.png" class="img-responsive" alt="How Blockchain Is Making It Easier to Get">
                                </div>
                                <div class="grid_body">
                                    <h3 class="post_heading"><a href="news/blockchain/how-blockchain-is-making-it-easier-to-get.html">How Blockchain Is Making It Easier to Get</a></h3>
                                    <time datetime="2018-04-09 10:35:24" class="time">
                                        9th, April 2018    
                                    </time>
                                    <p>Lorem ipsum dolor sit amet, quo omittam moderatius in, te cum mutat malorum. Autem ullum cu sed. Id per enim d</p>
                                </div>
                        ...
                        <div class="item">
                            <div class="post_grid">
                                <div class="grid_img">
                                    <img src="upload/news/32a158bf5a2f5b11e63bcca8b6578039.png" class="img-responsive" alt="How Can Blockchains Remove the ‘Pay to Trade’ Barrier in the Market?">
                                </div>
                                <div class="grid_body">
                                    <h3 class="post_heading"><a href="news/blockchain/how-can-blockchains-remove-the-pay-to-trade-barrier-in-the-market.html">How Can Blockchains Remove the ‘Pay to Trade’ Barrier in the Market?</a></h3>
                                    <time datetime="2018-04-09 09:59:55" class="time">
                                        9th, April 2018    
                                    </time>
                                    <p>Lorem ipsum dolor sit amet, quo omittam moderatius in, te cum mutat malorum. Autem ullum cu sed. Id per enim d</p>
                                </div>
                        ...
                        <div class="item">
                            <div class="post_grid">
                                <div class="grid_img">
                                    <img src="upload/news/59be39a3a7647f8219b84452e247acf3.jpg" class="img-responsive" alt="CANADIAN MINING GIANT HYPERBLOCK ACQUIRES CRYPTOGLOBAL FOR $106 MILLION">
                                </div>
                                <div class="grid_body">
                                    <h3 class="post_heading"><a href="news/mining/canadian-mining-giant-hyperblock-acquires-cryptoglobal-for-106-million.html">CANADIAN MINING GIANT HYPERBLOCK ACQUIRES CRYPTOGLOBAL FOR $106 MILLION</a></h3>
                                    <time datetime="2018-04-09 09:59:13" class="time">
                                        9th, April 2018    
                                    </time>
                                    <p>Lorem ipsum dolor sit amet, quo omittam moderatius in, te cum mutat malorum. Autem ullum cu sed. Id per enim d</p>
                                </div>
                        ...
                        <div class="item">
                            <div class="post_grid">
                                <div class="grid_img">
                                    <img src="upload/news/e7ea25eb9caf196ceac62c9b1d777014.jpg" class="img-responsive" alt="ASIC Resistance Increasingly Hot Topic in Crypto as Monero Forks">
                                </div>
                                <div class="grid_body">
                                    <h3 class="post_heading"><a href="news/mining/asic-resistance-increasingly-hot-topic-in-crypto-as-monero-forks.html">ASIC Resistance Increasingly Hot Topic in Crypto as Monero Forks</a></h3>
                                    <time datetime="2018-04-09 09:57:45" class="time">
                                        9th, April 2018    
                                    </time>
                                    <p>Lorem ipsum dolor sit amet, quo omittam moderatius in, te cum mutat malorum. Autem ullum cu sed. Id per enim d</p>
                                </div>
                        ...
                        <div class="item">
                            <div class="post_grid">
                                <div class="grid_img">
                                    <img src="upload/news/37c1c2dcd93cde3cbc82a699d2a5c383.jpg" class="img-responsive" alt="Why Invest in Dash?">
                                </div>
                                <div class="grid_body">
                                    <h3 class="post_heading"><a href="news/dash/why-invest-in-dash.html">Why Invest in Dash?</a></h3>
                                    <time datetime="2018-04-09 09:56:48" class="time">
                                        9th, April 2018    
                                    </time>
                                    <p>Lorem ipsum dolor sit amet, quo omittam moderatius in, te cum mutat malorum. Autem ullum cu sed. Id per enim d</p>
                                </div>
                        ...
                        <div class="col-sm-4 col-md-4">
                            <div class="widget-contact">
                                <ul class="list-icon">
                                    ...
                                    <li><i class="fa fa-envelope"></i> <a href="../cdn-cgi/l/email-protection.html#d8b1b6beb798babcacb9abb3f6bbb7b5"><span class="__cf_email__" data-cfemail="d6bfb8b0b996b4b2a2b7a5bdf8b5b9bb">[email&#160;protected]</span></a>
                                    </li>
                                    <li>
        ...
        <script type="text/javascript">
            $(function(){
               window.setTimeout(function(){
                    ...
                    $.ajax({
                            url: "http://phpcryptomarket.bdtask.com/demo-v1.6/home/cointrickerdata/",
                            type: "GET",
                            dataType : "json",
                            success: function(result,status,xhr) {
