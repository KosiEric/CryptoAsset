...
<!-- Mirrored from phpcryptomarket.bdtask.com/demo-v1.6/sells by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Oct 2018 01:51:53 GMT -->
...
<head>
        ...
        <title>Sells - Crypto Currency Treading System</title>
    ...
    <body>
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav" data-in="" data-out="">
                                ...
                                <li class=""><a href="home.php">Home</a>
                                                        ...
                                                        <li class="active "><a href="sell.php">Sells</a>
                                </li>
        ...
        </nav>        <div class="page_header" data-parallax-bg-image="http://phpcryptomarket.bdtask.com/demo-v1.6/upload/c68e8154891b01bb15f967d02a5ee3da.jpg" data-parallax-direction="">
                ...
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2">
                        <div class="form-content">
                            <form action="http://phpcryptomarket.bdtask.com/demo-v1.6/sells" id="sellform"  class="form-horizontal" name="sellform" enctype="multipart/form-data" method="post" accept-charset="utf-8">
<input type="hidden" name="csrf_test_name" value="5e2afe77814e90ae82ddc9e972c90b86" />                             
                                ...
                                <div class="form-group">
                                    <label class="col-sm-4 control-label">Company <i></i> Wallet ID</label>
                                    <div class="col-sm-8">
                                ...
                                <div class="row">
                                    <div class="col-sm-offset-4 col-sm-8">
                                        <h3 class="form-title">How do you receive money:</h3>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-4 control-label">Withdraw Method</label>
                                    <div class="col-sm-8">
                                ...
                                <span class="payment_info">
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label comments_level">Account Info</label>
                                        <div class="col-sm-8">
                                ...
                                <div class="form-group ">
                                    <label for="document" class="col-sm-4 control-label">Upload Docunemts</label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-offset-4 col-sm-8">
                                        <button type="submit" class="btn btn-default mr-10">Sell</button>
                        ...
                        <div class="col-sm-4 col-md-4">
                            <div class="widget-contact">
                                <ul class="list-icon">
                                    ...
                                    <li><i class="fa fa-envelope"></i> <a href="../cdn-cgi/l/email-protection.html#4920272f26092b2d3d283a22672a2624"><span class="__cf_email__" data-cfemail="e28b8c848da2808696839189cc818d8f">[email&#160;protected]</span></a>
                                    </li>
                                    <li>
        ...
        <script type="text/javascript">
            $(function(){
                $("#cid").on("change", function(event) {
                    ...
                    $.ajax({
                        url: "http://phpcryptomarket.bdtask.com/demo-v1.6/home/sellpayable",
                        type: "post",
                        data: inputdata,
                ...
                $("#sell_amount").on("keyup", function(event) {
                    ...
                    if (cid=="") {
                        ...
                        var inputdata = "cid="+cid+"&amount="+sell_amount+"&csrf_test_name=5e2afe77814e90ae82ddc9e972c90b86";
                ...
                $("#payment_method").on("change", function(event) {
                    ...
                    if (payment_method==='bitcoin') {
                        $(".payment_info").html("<div class='form-group row'><label class='col-sm-4 control-label comments_level'>Bitcoin Wallet ID</label><div class='col-sm-8'><textarea name='comments' class='form-control input-solid input-solid input-solid' placeholder='' type='text' id='comments' autocomplete='off'></textarea></div></div>");
                    }else if(payment_method==='payeer'){
                       $(".payment_info").html("<div class='form-group row'><label class='col-sm-4 control-label comments_level'>Payeer Wallet Id</label><div class='col-sm-8'><textarea name='comments' class='form-control input-solid input-solid input-solid' placeholder='' type='text' id='comments' autocomplete='off'></textarea></div></div>");
